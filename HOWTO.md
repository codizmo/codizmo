...
1. Add a new file to it (clicking the + button at the top right). Name it index.html if you plan to use HTML to create your page or README.md if you want to use markdown for your page to keep things simple
