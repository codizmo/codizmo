...
## Externel parameter UI pages
Codizmo does not stop at allowing static pages to be shown to give additional explanations about a parameter. Instead it provides a complete interface to show external pages implementing UIs of any complexity and allowing them to pass values entered by users back to the actual parameter field used for rendering afterwards. Find [explanations about external UI pages here](EXTERNAL-PARAM-UI.md).
